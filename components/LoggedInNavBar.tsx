    ...
    >
      <div className="max-w-screen-xl mx-auto flex items-center px-2 w-full relative">
        ...
        >
          ...
          <span className="lg:hidden pl-1 text-left text-[9px] leading-tight text-white/80 whitespace-nowrap">
        ...
        <div className="flex lg:hidden items-center gap-4 ml-auto" ref={mobileMenuRef}>
          ...
          <button
            ...
            className="h-9 w-9 inline-flex items-center justify-center leading-none text-white hover:text-gray-300 -mt-2"
