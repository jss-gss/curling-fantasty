      ...
      <div className="relative w-full min-h-screen overflow-x-hidden">
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-[1450px] mx-auto gap-6 py-6 px-4 lg:py-10 lg:px-6">
          ...
          <div className="flex flex-col flex-1 gap-4 lg:gap-6">
            ...
            <div className="lg:hidden bg-white shadow-md p-4 mt-2 rounded-lg">
              <NextMajorEvent />
            </div>

            {nextDraft && (
              <div className="mt-2 sm:mt-0 bg-white shadow-md p-4 lg:p-6 rounded-lg flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
