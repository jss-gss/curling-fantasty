...
export default function LeaguesPage() {
  ...
  function LeagueCard({ league }: any) {
    ...
    return (
      <div className="flex items-center justify-between bg-white shadow-md p-6 border border-gray-200 rounded-lg">
        ...
        {league.enrolled ? (
          league.draft_status === "closed" ? (
            ...
            <button
              ...
              className="bg-red-600 text-white px-6 py-2 hover:bg-[#AA2B1D] transition rounded-md"
            >
              Leave
            </button>
          )
